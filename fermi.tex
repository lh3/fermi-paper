...
overlaps. In the resulting graph, each unambiguous path spells a
contig.
...
roughly linear in the total length of reads.
...
assembly and Michael Brudno for his insight into the time complexity of
assembly algorithms.
