...
\DontPrintSemicolon
\footnotesize
\KwIn{Sequence index $i\ge0$; $B$, $O$ and $C$ defined in the text}
\KwOut{Sequence $P$ and $k$, the rank of $P$}
\BlankLine
\textbf{Function} {\sc GetSeq}$(i)$
\Begin {
	$k\gets i$\;
	$P\gets$ \emph{empty string}\;
	\While{\bf true} {
		$a\gets B[k]$\;
		$k\gets C(a)+O(a,k)-1$\;
		\If{$a=0$}{
...
Aligned contig bp    & 2.73G & 2.60G & 2.81G & 2.74G & 2.81G \\
Aligned N50          &  9.4k & 23.8k & 15.8k &  9.9k &103.0k \\
Covered ref. bp      & 2.69G & 2.59G & 2.74G & 2.70G & 2.78G \\
\# Type-1 breaks     & 1,524 & 3,382 &   920 & 1,562 & 4,728 \\
\# Type-2 breaks     & 1,495 & 3,314 &   897 & 1,534 & 4,503 \\
\botrule
\end{tabular}}{Contigs over 150bp in length are aligned to the human reference
genome GRCh37 with BWA-SW using option `-b9 -q16 -r1 -w500'. A type-1 break point
...
% -----------------------------------------------------------
% MD  240424 196936 225339 163070 227796  149559 12981 234930
% CG  199071 264696 242198 166611 244573  160786 13861 255440
% BS  228431 241722 404646 201341 341626  228833 17682 366599
% CV  178131 182752 222029 251769 227206  164320 13045 232406
% FC  231787 245165 344031 205983 393841  239822 17726 374760
% AC  151147 159973 227291 143648 236222  321682 13784 252817
% MI   13772  14348  18350  12226  18672   14740 23216  20069
