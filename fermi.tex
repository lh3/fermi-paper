...
and compared the performance of fermi (Table~4 and 5). For INDEL calling from
assembled sequences, we only directly count INDELs from the SAMtools' pileup
output, instead of running a standard INDEL caller as short-read INDEL callers
do not work well with long contig sequences.
